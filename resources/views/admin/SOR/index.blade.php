...
@section('content')
<h3 class="font-weight-bold text-center bg-gradient-dark text-light p-4">Summary of Records</h3>
  ...
  <div class="row row-cols-2 row-cols-lg-3 row-cols-md-3 g-5 g-lg-3 py-3">
    <div class="col">
        <div class="p-3 border bg-gradient-light d-flex flex-column justify-content-center align-items-center">
            ...
            <a data-toggle="modal" data-target="#CAScourseModal" class="btn btn-primary btn-block">
    ...
    <div class="col">
        <div class="p-3 border bg-gradient-light d-flex flex-column justify-content-center align-items-center">
            ...
            <a data-toggle="modal" data-target="#CCScourseModal" class="btn btn-primary btn-block">
    ...
    <div class="col">
        <div class="p-3 border bg-gradient-light d-flex flex-column justify-content-center align-items-center">
            ...
            <a data-toggle="modal" data-target="#CEAcourseModal" class="btn btn-primary btn-block">
    ...
    <div class="col">
        <div class="p-3 border bg-gradient-light d-flex flex-column justify-content-center align-items-center">
            ...
            <a data-toggle="modal" data-target="#CHScourseModal" class="btn btn-primary btn-block">
    ...
    <div class="col">
        <div class="p-3 border bg-gradient-light d-flex flex-column justify-content-center align-items-center">
            ...
            <a data-toggle="modal" data-target="#CTDEcourseModal" class="btn btn-primary btn-block" style="font-size: 13px;">
        ...
        <div class="col">
            <div class="p-3 border bg-gradient-light d-flex flex-column justify-content-center align-items-center">
                ...
                <a data-toggle="modal" data-target="#CTHBMcourseModal" class="btn btn-primary btn-block" style="font-size: 12px;">            
