...
class ProgramController extends Controller
{
    ...
    {   
        ...
        return view('admin.Program.addProgram', compact('program', 'courses'));
    }

    public function departmentIndex()
    {
        return view('admin.Program.addDepartment');
    }
    ...
    public function update(Request $request, Program $program)
    {
        ...
        return redirect()->route('admin.Program.addDepartment')->with('success', 'Department updated successfully.');
    }
    ...
    {
        $program->delete();
        return redirect()->route('admin.Program.addDepartment')->with('success', 'User deleted successfully.');
    }
}